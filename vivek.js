...
vivekmasonaAudDivElem.style.height="60px";
...
window.location.href="https://youtube.com"+document.getElementsByTagName("lazy-list")[1].children[1].children[0].children[0].getAttribute("href")+"&auds=ab";
}
});
}
else {
